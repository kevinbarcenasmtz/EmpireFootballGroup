      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="bg-contrast rounded-lg border border-gray-200 p-4 shadow-sm sm:p-6 dark:border-gray-700">
          <form action={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div>
              <label htmlFor="collection_type" className="text-text-primary mb-2 block text-sm font-medium">
                Collection Type *
              </label>
              <select
                id="collection_type"
                ...
                className="text-text-primary bg-contrast w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 sm:text-base dark:border-gray-600"
                required
              >
            ...
            <div>
              ...
              <input
                ...
                type="text"
                required
                placeholder={collectionType === 'payment' 
            ...
            {/* Description */}
            <div>
              <label htmlFor="description" className="text-text-primary mb-2 block text-sm font-medium">
                Description
              </label>
              <textarea
                id="description"
            ...
            {collectionType === 'payment' && (
              <div>
                <label htmlFor="target_amount" className="text-text-primary mb-2 block text-sm font-medium">
                  Target Amount (optional)
                </label>
                <div className="relative">
                  <span className="text-text-secondary absolute left-3 top-1/2 -translate-y-1/2 text-sm sm:text-base">
                    $
                  </span>
                  <input
                    id="target_amount"
                    ...
                    min="0"
                    placeholder="0.00"
                    className="text-text-primary bg-contrast w-full rounded-md border border-gray-300 pl-8 pr-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 sm:text-base dark:border-gray-600"
                  />
                </div>
                <p className="text-text-secondary mt-1 text-xs sm:text-sm">
            ...
            {collectionType === 'signup' && (
              <>
                ...
                {/* Event Date */}
                <div>
                  <label htmlFor="event_date" className="text-text-primary mb-2 block text-sm font-medium">
                    Event Date & Time
                  </label>
                  <input
                    id="event_date"
                ...
                {/* Location */}
                <div>
                  <label htmlFor="location" className="text-text-primary mb-2 block text-sm font-medium">
                    Location
                  </label>
                  <input
                    id="location"
