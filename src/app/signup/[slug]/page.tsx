...
import { submitSignup, getCollectionForSignup, findExistingSignup } from '../../actions/signup-actions';
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8 dark:bg-gray-900">
      <div className="mx-auto max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="mx-auto mb-4 h-12 w-12 text-penn-red">
        ...
        {success && (
          <div className="mb-6 rounded-lg bg-green-50 border border-green-200 p-4 dark:bg-green-900/20 dark:border-green-800">
            <div className="flex items-center">
              ...
              <p className="text-green-700 text-sm font-medium dark:text-green-400">
                {success}
              </p>
            </div>
          </div>
        ...
        {showPhoneLookup && !existingSignup && (
          <div className="mb-6 rounded-lg bg-blue-50 border border-blue-200 p-4 dark:bg-blue-900/20 dark:border-blue-800">
            <h3 className="text-blue-900 font-medium mb-3 dark:text-blue-100">
            ...
            <button
              ...
              className="text-blue-600 hover:text-blue-800 text-sm mt-2 dark:text-blue-400"
            >
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm dark:bg-gray-800 dark:border-gray-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Player Name */}
            <div>
              <label htmlFor="player_name" className="text-text-primary block text-sm font-medium mb-2">
                Your Name *
              </label>
              <input
                id="player_name"
                ...
                className="text-text-primary bg-contrast w-full rounded-md border border-gray-300 px-3 py-2 text-base focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600"
            ...
            {/* Phone Number */}
            <div>
              <label htmlFor="player_phone" className="text-text-primary block text-sm font-medium mb-2">
                ...
                {[
                  ...
                  >
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, status: e.target.value as SignupStatus }))}
            ...
            {/* Notes */}
            <div>
              <label htmlFor="notes" className="text-text-primary block text-sm font-medium mb-2">
            ...
            <button
              ...
              className="bg-penn-red hover:bg-lighter-red w-full rounded-md px-4 py-3 text-base font-medium text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
                ...
                existingSignup ? 'Update Response' : 'Submit Signup'
              )}
            </button>
          </form>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-text-secondary text-sm">
            Powered by Empire Football Group
          </p>
        </div>
      </div>
    </div>
