...
export const Hero = () => {
  return (
    <Container className="flex flex-wrap items-center justify-center px-4 py-8 lg:justify-between lg:py-16">
      {/* Left section */}
      <div className="flex w-full flex-col items-center lg:w-1/2 lg:items-start lg:pr-6">
        <h1 className="text-smoky-black text-center text-3xl leading-snug font-bold tracking-tight lg:text-left lg:text-4xl xl:text-6xl">
